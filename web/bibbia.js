...
var that=this
var BOOKS={'1tim':'1tm','dn':'dan','gn':'gen','ml':'mal','mat':'mt','nm':'num','prv':'pro','rm':'rom','rt':'rut','zc':'zac'}
var CLEAN=new RegExp('([^ <]*)<([^>]*)>','g')
var FBrkl=''
var FStat
var FHide
var NameChar= "A-Za-z0-9_-àèìòùé"
var NOTES1=new RegExp('{ *([^}]*) *}','g')
var NOTES2=new RegExp('#(['+NameChar+']+)(/(['+NameChar+']+))?','g')
var abs= Math.abs, max= Math.max
var log= Math.log, exp= Math.exp
var pow= Math.pow, sqrt= Math.sqrt
var round= Math.round, floor= Math.floor
var PI= Math.PI, L2= log(2)
...
function truevers(v) {
  var V={'b':'bgm','e':'ebr','g':'grk','i':'it-2008','74':'it-1974','n':'notes','ilc':'tilc','t':'titles'}
